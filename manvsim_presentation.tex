\documentclass[german,10pt,aspectratio=169]{beamer}
...
\setbeamertemplate{}{\hfill\includegraphics}
\titlegraphic{\hfill\includegraphics[width=1.5cm]{images/cau-tf-inf.png}}%\hspace{0.2cm}\vspace{0cm}}
...
% TODO: Reenable when bug with TOC is fixed?
